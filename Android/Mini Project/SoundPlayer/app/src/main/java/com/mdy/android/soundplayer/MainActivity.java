...
import com.mdy.android.soundplayer.util.fragment.PagerAdapter;

import static com.mdy.android.soundplayer.R.id.tab;
...
public class MainActivity extends AppCompatActivity
    ...
    private void init(){
        ...
        adapter.add(new com.mdy.android.soundplayer.ThreeFragment());
    ...
    private void checkPermission() {
        if ( Build.VERSION.SDK_INT >= Build.VERSION_CODES.M ) {
            if( com.mdy.android.soundplayer.PermissionControl.checkPermission(this, REQ_PERMISSION) ){
                init();
            }
        }else{
            init();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == REQ_PERMISSION){
            if( com.mdy.android.soundplayer.PermissionControl.onCheckResult(grantResults)){
                init();
            }else{
