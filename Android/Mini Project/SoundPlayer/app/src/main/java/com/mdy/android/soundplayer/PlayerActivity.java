...
public class PlayerActivity extends AppCompatActivity implements ControlInterface {
    ...
    // 뷰페이저
    ViewPager viewPager;
    com.mdy.android.soundplayer.PlayerAdapter adapter;
    // 위젯
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 2. 뷰페이저용 아답터 생성
        adapter = new com.mdy.android.soundplayer.PlayerAdapter(datas ,this);
        // 3. 뷰페이저 아답터 연결
    ...
    private void play() {
        Intent intent = new Intent(this, com.mdy.android.soundplayer.SoundService.class);
        intent.setAction(com.mdy.android.soundplayer.SoundService.ACTION_PLAY);
