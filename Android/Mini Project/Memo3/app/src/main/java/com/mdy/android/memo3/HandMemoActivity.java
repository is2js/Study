...
public class HandMemoActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                switch (checkedId) {
                    case R.id.radioBlack:
                        ...
                        Toast.makeText(HandMemoActivity.this, "검정색 붓이 선택되었습니다.", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.radioGreen:
                        setBrush(Color.GREEN, thickType);
                        colorType = Color.GREEN;
                        Toast.makeText(HandMemoActivity.this, "초록색 붓이 선택되었습니다.", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.radioBlue:
                        setBrush(Color.BLUE, thickType);
                        colorType = Color.BLUE;
                        Toast.makeText(HandMemoActivity.this, "파란색 붓이 선택되었습니다.", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.radioRed:
                        setBrush(Color.RED, thickType);
                        colorType = Color.RED;
                        Toast.makeText(HandMemoActivity.this, "빨간색 붓이 선택되었습니다.", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        });
        ...
        findViewById(R.id.btnReset).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                board.removeBrush();
                Toast.makeText(HandMemoActivity.this, "초기화 되었습니다.", Toast.LENGTH_SHORT).show();
            }
        });
