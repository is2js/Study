package com.mdy.android.firebasefcm;
...
public class MainActivity extends AppCompatActivity implements CustomAdapter.IParent{
    ...
    private void setWidget(){
        ...
        textReceive = (TextView) findViewById(R.id.txtReceive);
    ...
    public interface FcmService {
        public static final String SERVER_URL = "http://192.168.10.79:8080/";
    ...
    public void sendMsg(View view){
        ...
        result.enqueue(new Callback<Result>() {
            @Override
            public void onResponse(Call<Result> call, Response<Result> response) {  // 성공하면 여기로 값이 넘어온다.
            ...
            @Override
            public void onFailure(Call<Result> call, Throwable t) { // 통신 장애
